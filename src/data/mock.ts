...
const finalsByChild: Record<string, FinalsPayload> = {
  nika: {
    yearLabel: "2025/2026",
    rows: [
      { subject: "Изобразительное искусство", t1: 4, t2: 5, t3: 5, t4: 4.25, year: 4.56 },
      { subject: "Иностранный (английский) язык", t1: 5, t2: 4, t3: 5, t4: 4.75, year: 4.69 },
      { subject: "Литературное чтение", t1: 3, t2: 4, t3: 5, t4: 4.5, year: 4.13 },
      { subject: "Математика", t1: 5, t2: 3, t3: 4, t4: 3.85, year: 3.96 },
      { subject: "Музыка", t1: 4, t2: 5, t3: 3, t4: 4.2, year: 4.05 },
      { subject: "Окружающий мир", t1: 5, t2: 5, t3: 4, t4: 4.4, year: 4.6 },
      { subject: "Русский язык", t1: 4, t2: 4, t3: 5, t4: 4.1, year: 4.28 },
      { subject: "Труд (технология)", t1: 3, t2: 5, t3: 5, t4: 4.6, year: 4.4 },
      { subject: "Физическая культура", t1: 5, t2: 5, t3: 4, t4: 4.9, year: 4.73 },
    ],
  },
  efrem: {
    yearLabel: "2025/2026",
    rows: [
      { subject: "Алгебра", t1: 4, t2: 3, t3: 5, t4: 4.2, year: 4.05 },
      { subject: "Геометрия", t1: 5, t2: 4, t3: 3, t4: 4.35, year: 4.09 },
      { subject: "Русский язык", t1: 4, t2: 5, t3: 5, t4: 4.1, year: 4.53 },
      { subject: "История", t1: 3, t2: 5, t3: 5, t4: 4.45, year: 4.36 },
      { subject: "Физика", t1: 5, t2: 5, t3: 3, t4: 4.5, year: 4.38 },
      { subject: "Литература", t1: 4, t2: 4, t3: 5, t4: 4.7, year: 4.43 },
      { subject: "Иностранный (английский) язык", t1: 5, t2: 4, t3: 5, t4: 4.85, year: 4.71 },
      { subject: "Информатика", t1: 5, t2: 5, t3: 4, t4: 4.55, year: 4.64 },
      { subject: "Биология", t1: 4, t2: 5, t3: 4, t4: 4.25, year: 4.31 },
      { subject: "География", t1: 3, t2: 4, t3: 4, t4: 3.9, year: 3.73 },
      { subject: "Обществознание", t1: 5, t2: 3, t3: 4, t4: 4.3, year: 4.08 },
    ],
  },
};
